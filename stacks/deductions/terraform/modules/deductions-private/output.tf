...
resource "aws_ssm_parameter" "deductions_private_private_subnets" {
  name  = "/repo/${var.environment}/output/output/prm-deductions-infra/deductions-private-private-subnets"
  type  = "String"
...
resource "aws_ssm_parameter" "deductions_private_vpc_id" {
  name  = "/repo/${var.environment}/output/output/prm-deductions-infra/private-vpc-id"
  type  = "String"
  value = module.vpc.vpc_id
  tags = {
    CreatedBy   = var.repo_name
...
resource "aws_ssm_parameter" "deductions_private_database_subnets" {
  name  = "/repo/${var.environment}/output/output/prm-deductions-infra/deductions-private-database-subnets"
  type  = "String"
