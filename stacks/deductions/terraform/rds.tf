...
resource "aws_ssm_parameter" "repo_databases" {
  name  = "/repo/${var.environment}/output/output/prm-deductions-infra/repo-databases-parameter-group-name"
  type  = "String"
...
resource "aws_ssm_parameter" "repo_databases_version_13" {
  name  = "/repo/${var.environment}/output/output/prm-deductions-infra/repo-databases-parameter-group-name-version-13"
  type  = "String"
