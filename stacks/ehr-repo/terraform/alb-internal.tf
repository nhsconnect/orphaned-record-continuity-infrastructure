...
resource "aws_ssm_parameter" "deductions_core_internal_alb_dns" {
  name  = "/repo/${var.environment}/output/prm-deductions-ehr-repository/deductions-core-internal-alb-dns"
  type  = "String"
...
resource "aws_ssm_parameter" "deductions_core_int_alb_httpl_arn" {
  name  = "/repo/${var.environment}/output/prm-deductions-ehr-repository/deductions-core-int-alb-httpl-arn"
  type  = "String"
...
resource "aws_ssm_parameter" "deductions_core_int_alb_httpsl_arn" {
  name  = "/repo/${var.environment}/output/prm-deductions-ehr-repository/deductions-core-int-alb-httpsl-arn"
  type  = "String"
