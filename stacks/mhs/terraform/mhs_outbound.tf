...
resource "aws_ssm_parameter" "service_to_mhs_outbound" {
  name  = "/repo/${var.environment}/output/prm-mhs-infra/service-to-${var.cluster_name}-mhs-outbound-sg-id"
  type  = "String"
...
resource "aws_ssm_parameter" "outbound_url" {
  name  = "/repo/${var.environment}/output/prm-mhs-infra/${var.cluster_name}-mhs-outbound-url"
  type  = "String"
