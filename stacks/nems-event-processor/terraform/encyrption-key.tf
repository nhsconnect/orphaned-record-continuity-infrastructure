...
resource "aws_ssm_parameter" "suspensions_kms_key_id" {
  name  = "/repo/${var.environment}/output/prm-deductions-infra/suspensions-kms-key-id"
  type  = "String"
...
resource "aws_ssm_parameter" "re_registrations_kms_key_id" {
  name  = "/repo/${var.environment}/output/prm-deductions-infra/re-registrations-kms-key-id"
  type  = "String"
...
resource "aws_ssm_parameter" "dlq_kms_key_id" {
  name  = "/repo/${var.environment}/output/prm-deductions-infra/dlq-kms-key-id"
  type  = "String"
