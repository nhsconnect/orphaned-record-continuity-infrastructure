...
data "archive_file" "lambda" {
  type        = "zip"
  source_file = "${path.root}/../../../lambdas/${local.ingestion_lambda_name}-lambda/${local.ingestion_lambda_name}.py"
  output_path = "${path.root}/../../../lambdas/${local.ingestion_lambda_name}-lambda/${local.ingestion_lambda_name}_payload.zip"
}
